...
|---|---|---|---|---|---|---|---|
| H1 | occupancy | imidacloprid | occupancy_gap_insect_minus_vertebrate | increase | 0.872 | 16 | software_prediction |
| H2 | subgraph | imidacloprid | mean_hz | decrease | -5.924 | 23 | software_prediction |
| H3 | subgraph | fipronil | mean_hz | increase | 0.863 | 16 | software_prediction |
...
| H6 | taste_map | fipronil | bitter_veto_ratio | increase | 0.410 | 16 | software_prediction |
| H7 | subgraph | picrotoxin | mean_hz | increase | 0.419 | 16 | software_prediction |
