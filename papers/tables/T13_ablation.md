**T13_ablation.** Ablation ladder. Each level is a prediction for the same compound-concentration cell from a model that has been denied one layer of information: receptor engagement only (dimensionless), mechanism gains on the graph's transmitter composition only (excitation index), the real cut with one generic multiplier instead of mechanism-specific gains (Hz), and the full model (Hz). Levels have different units, so they are compared by ordering, never by value.

| compound | class | conc_M | A_receptor_only | B_composition_only | C_topology_only | D_full_flylab |
|---|---|---|---|---|---|---|
| acetamiprid | neonicotinoid | 1.00e-08 | 0.127 | 0.543 | -0.848 | 0.191 |
...
| chlorpyrifos_oxon | organophosphate (oxon metabolite) | 1.00e-08 | -0.500 | 47.8 | -3.285 | 41.9 |
| clothianidin | neonicotinoid | 1.00e-08 | 0.211 | 0.286 | -1.407 | 0.100 |
| ddt | organochlorine | 1.00e-08 | 1.54e-04 | 0.002 | -0.001 | 0.003 |
| deltamethrin | type II pyrethroid | 1.00e-08 | 0.189 | 3.059 | -1.259 | 4.405 |
| diazepam | benzodiazepine | 1.00e-08 | 0.000 | 0.000 | 0.000 | 0.000 |
| dieldrin | cyclodiene organochlorine | 1.00e-08 | -0.091 | 1.048 | -0.611 | 0.071 |
| fipronil | phenylpyrazole | 1.00e-08 | -0.211 | 2.433 | -1.407 | 0.168 |
| gaba | endogenous transmitter | 1.00e-08 | 2.83e-06 | -1.30e-05 | -1.91e-05 | -8.67e-07 |
| imidacloprid | neonicotinoid | 1.00e-08 | 1.295 | -0.562 | -6.169 | -0.194 |
| ivermectin | avermectin | 1.00e-08 | 0.343 | 0.113 | -2.206 | -0.016 |
| nicotine | alkaloid | 1.00e-08 | 0.036 | 0.266 | -0.241 | 0.093 |
| nitenpyram | neonicotinoid | 1.00e-08 | 0.127 | 0.543 | -0.848 | 0.191 |
...
| deltamethrin | type II pyrethroid | 1.00e-07 | 0.699 | 11.3 | -4.565 | 24.0 |
| diazepam | benzodiazepine | 1.00e-07 | 0.000 | 0.000 | 0.000 | 0.000 |
| dieldrin | cyclodiene organochlorine | 1.00e-07 | -0.500 | 5.764 | -3.285 | 0.424 |
| fipronil | phenylpyrazole | 1.00e-07 | -0.809 | 9.328 | -5.269 | 0.738 |
| gaba | endogenous transmitter | 1.00e-07 | 8.94e-05 | -4.12e-04 | -6.05e-04 | -2.74e-05 |
| imidacloprid | neonicotinoid | 1.00e-07 | 1.873 | -10.8 | -6.169 | -5.680 |
...
| permethrin | type I pyrethroid | 1.00e-07 | 0.200 | 3.243 | -1.334 | 4.710 |
| picrotoxin | plant convulsant | 1.00e-07 | -0.091 | 1.048 | -0.611 | 0.071 |
| spinosad | spinosyn | 1.00e-07 | 0.039 | 0.157 | -0.132 | 0.055 |
...
| acetylcholine | endogenous transmitter | 1.00e-06 | 0.059 | 0.394 | -0.400 | 0.138 |
| caffeine | methylxanthine | 1.00e-06 | 0.000 | 0.000 | 0.000 | 0.000 |
| chlordimeform | formamidine | 1.00e-06 | 0.032 | 0.000 | -0.218 | 0.000 |
...
| ddt | organochlorine | 1.00e-06 | 0.015 | 0.246 | -0.102 | 0.308 |
| deltamethrin | type II pyrethroid | 1.00e-06 | 0.959 | 15.5 | -6.169 | 37.2 |
| diazepam | benzodiazepine | 1.00e-06 | 0.000 | 0.000 | 0.000 | 0.000 |
| dieldrin | cyclodiene organochlorine | 1.00e-06 | -0.909 | 10.5 | -5.908 | 0.851 |
| fipronil | phenylpyrazole | 1.00e-06 | -0.985 | 11.0 | -6.169 | 0.900 |
| gaba | endogenous transmitter | 1.00e-06 | 0.003 | -0.013 | -0.019 | -8.64e-04 |
| imidacloprid | neonicotinoid | 1.00e-06 | 1.991 | -10.8 | -6.169 | -6.173 |
...
| permethrin | type I pyrethroid | 1.00e-06 | 0.714 | 11.6 | -4.661 | 24.8 |
| picrotoxin | plant convulsant | 1.00e-06 | -0.500 | 5.764 | -3.285 | 0.424 |
| spinosad | spinosyn | 1.00e-06 | 0.333 | 0.483 | -1.114 | 0.170 |
...
| chlordimeform | formamidine | 1.00e-05 | 0.250 | 0.000 | -1.662 | 0.000 |
...
| ddt | organochlorine | 1.00e-05 | 0.133 | 2.162 | -0.893 | 2.982 |
| deltamethrin | type II pyrethroid | 1.00e-05 | 0.996 | 16.1 | -6.169 | 38.2 |
| diazepam | benzodiazepine | 1.00e-05 | 0.000 | 0.000 | 0.000 | 0.000 |
| dieldrin | cyclodiene organochlorine | 1.00e-05 | -0.990 | 11.0 | -6.169 | 0.900 |
| fipronil | phenylpyrazole | 1.00e-05 | -0.999 | 11.0 | -6.169 | 0.900 |
| gaba | endogenous transmitter | 1.00e-05 | 0.082 | -0.379 | -0.552 | -0.025 |
| imidacloprid | neonicotinoid | 1.00e-05 | 1.999 | -10.8 | -6.169 | -6.173 |
...
| permethrin | type I pyrethroid | 1.00e-05 | 0.962 | 15.6 | -6.169 | 37.2 |
| picrotoxin | plant convulsant | 1.00e-05 | -0.909 | 10.5 | -5.908 | 0.851 |
| spinosad | spinosyn | 1.00e-05 | 1.333 | -9.663 | -4.356 | -3.041 |
| sulfoxaflor | sulfoximine | 1.00e-05 | 0.063 | 0.408 | -0.421 | 0.143 |
| thiamethoxam | neonicotinoid | 1.00e-05 | 0.091 | 0.503 | -0.611 | 0.177 |
