**T8_landscape.** Selectivity landscape: the receptor index log10(EC50_vert / EC50_insect) against the circuit index log10(C_vert) - log10(C_circuit) on each committed graph. A negative gap means the neighbourhood buffers what the receptor numbers promise.

| compound | class | graph | receptor_si_log10 | circuit_si_log10 | si_gap_circuit_minus_receptor |
|---|---|---|---|---|---|
| acetamiprid | neonicotinoid | named | 3.301 | 2.409 | -0.892 |
...
| fipronil | phenylpyrazole | taste_motor | 1.564 | -- | -- |
| gaba | endogenous transmitter | named | -0.699 | -- | -- |
| gaba | endogenous transmitter | taste_motor | -0.699 | -- | -- |
| imidacloprid | neonicotinoid | named | 2.699 | 1.794 | -0.905 |
| imidacloprid | neonicotinoid | taste_motor | 2.699 | 1.790 | -0.909 |
| ivermectin | avermectin | named | 1.699 | -- | -- |
| ivermectin | avermectin | taste_motor | 1.699 | -- | -- |
| nicotine | alkaloid | named | 0.699 | -0.132 | -0.831 |
