...
| **6i Scale ladder (new)** | the same profile across nested extracts of 1k-50k cells | **done in v0.6.1** — the verdict settles as topology-dependent, and recurrence rather than size predicts the inversion (T27) |
